  ...
  feedbacks: [
    {
      img: user1,
      name: "Ayush Agarwal",
      desc: "The ambience of the place is good with lots of open space,but the care can be improved more it's upto the mark but certain standards could be maintained as a leading hospital in the area.",
    },
    {
      img: user2,
      name: "Narendra Athya",
